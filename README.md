...
На данный момент имеются входные данные без известных целевых переменных, поэтому доступен только подход обучения без учителя.
...
- возможность просмотра результатов предсказания нейросети.
***
## Входные данные
